...
extension MySwipeVC: EZSwipeControllerDataSource {
    ...
    func viewControllerData() -> [UIViewController] {
        ...
        let char = UIImageView(x: 50, y: 100, imageName: "button-discovery-normal", scaleToWidth: 300)
        ...
        let squir = UIImageView(x: 50, y: 100, imageName: "button-discovery-normal", scaleToWidth: 300)
        blueVC.view.addSubview(squir)

        let greenVC = UIViewController()
        greenVC.view.backgroundColor = UIColor.green
        let bulb = UIImageView(x: 50, y: 125, imageName: "button-discovery-normal", scaleToWidth: 300)
    ...
    func navigationBarDataForPageIndex(_ index: Int) -> UINavigationBar {
        ...
        if index == 0 {
            var sImage = UIImage(named: "button-discovery-normal")!
            ...
            var cImage = UIImage(named: "button-discovery-normal")!
            ...
            var bImage = UIImage(named: "button-discovery-normal")!
